			...
			<div class="adminContentBox">
				<div class="adminitemTable">
					...
					<table class="adminitemTableList">
						...
						<tr onclick="location.href='/adminitemonlineview/${list.ino}'">
							<td>${status.count}</td>
							...
							<td>
								<input type="button" value="수정" class="adminitemreset" onclick="location.href='/adminitemonlineupdate/${list.ino}'">
							</td>
						</tr>
						</c:forEach>
					</table>
