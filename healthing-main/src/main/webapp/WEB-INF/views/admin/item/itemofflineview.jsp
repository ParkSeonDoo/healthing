			...
			<div class="adminContentBox">
				<div class="itemWriteDetail">
					...
					<div class="itemWriteBtn">
						<input type="button" value="수정" onclick="location.href='/adminitemofflineupdate/${view.ino}'">
						<input type="button" value="목록" onclick="location.href='/adminitemoffline'">
						<input type="button" value="삭제" onclick="location.href='/adminitemofflinedelete/${view.ino}'">
					</div>
				</div>
			</div>
		</div>	
